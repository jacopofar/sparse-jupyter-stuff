...
adium_export_file = 'adium_chat_messages.tsv'
...
intermediate_tgcli = 'tsv_tg_chat.tsv'
...
engine = sa.create_engine('postgresql+psycopg2://localhost/clogs', use_batch_mode=True)
conn = engine.connect()
